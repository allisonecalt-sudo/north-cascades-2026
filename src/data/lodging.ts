...
export const WEST_LODGING: Lodging[] = [
  {
    ...
    phone: '(360) 873-2250',
    type: 'Theme cabins · full kitchen · gas fireplace',
    vibe: 'cabin',
    pricePerNight: '$150-250 peak',
    distance: '~10 min west of Marblemount · ~1 hr to Cascade Pass trailhead',
    notes:
      'Fully equipped theme cabins (recently remodeled) with full kitchens — the kosher-cooking pick. On-site Clark’s Eatery is non-kosher but ignorable. Matches the spacious-cabin brief.',
  ...
  },
  {
    ...
    notes:
      'Cabins with kitchenettes, sofa beds, smart TVs, free WiFi. Winery + restaurant on property are non-kosher. Kitchenette is enough for breakfasts + light dinners. [verify kitchen scope before trip]',
...
export const EAST_LODGING: Lodging[] = [
  {
    id: 'freestone',
    name: 'Freestone Inn — book the cabins',
    address: '31 Early Winters Dr, Mazama, WA 98833',
    phone: '(509) 996-3906',
    type: 'Rustic cabins with full kitchens (NOT lodge rooms)',
    vibe: 'lodge',
    pricePerNight: '$300+ cabins (Aug peak)',
    distance: '15 mi west of Winthrop · ~25 min to Rainy Pass',
    notes:
      'Cabins have full kitchens — the kosher-cooking pick. Lodge rooms do NOT (drop priority). Pool, hot tub, on-site restaurant non-kosher. Closest east-side stay to Rainy Pass.',
